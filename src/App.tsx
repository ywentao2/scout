    ...
    <div className="mid_align">
      <img className="img1" src={robotImage} alt='robot'/>
          <div className='right_card'>
            <input type='image' src={climber_close} alt='climber button' onClick={() => setRobotImage(climber)}></input>
            <input type='image' src={placeholder_96} alt='intake button' onClick={() => setRobotImage(intake)}></input>
            <input type='image' src={placeholder_96} alt='shooter button'onClick={() => setRobotImage(shooter)}></input>
          </div>
